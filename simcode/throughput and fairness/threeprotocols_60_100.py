...
def main1(request_list:list,seed:int,mc_list:list,rate_list:list):
    ...
    topo = RandomTopology(nodes_number = 60,
                          lines_number = 100,
...
if __name__ == "__main__":
    ...
    while (k < round):
        ...
        for i in range (10,25,2):
            ...
            EDR_list1[int(i/2-5)] += EDR1
            jain_list1[int(i/2-5)] += jain1
            min_EDR1_list1[int(i/2-5)] += min_EDR1
            EDR_list2[int(i/2-5)] += EDR2
            jain_list2[int(i/2-5)] += jain2
            min_EDR2_list2[int(i/2-5)] += min_EDR2
            EDR_list3[int(i/2-5)] += EDR3
            jain_list3[int(i/2-5)] += jain3
            min_EDR3_list3[int(i/2-5)] += min_EDR3
    # 收集数据
